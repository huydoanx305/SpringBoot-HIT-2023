package hit.com.codebuoi9.config;

import hit.com.codebuoi9.filter.AuthTokenFilter;
import hit.com.codebuoi9.service.UserDetailServiceImp;
...
public class SecurityConfig extends WebSecurityConfigurerAdapter {
    ...
    protected void configure(HttpSecurity http) throws Exception {
        http
                ...
                .authorizeRequests()
                .antMatchers("/api/v1/user/get_user/**").
